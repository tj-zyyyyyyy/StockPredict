...
# master
parser.add_argument('--d_feat', type=int, default=12, help='feature dimension')
...
parser.add_argument('--finbert_num_attention_heads', type=int, default=12, help='Number of attention heads in the model')
...
parser.add_argument('--alpha_tweet_loss', type=float, default=0, help='alpha for tweet')
parser.add_argument('--alpha_data_loss', type=float, default=1, help='alpha for data')
parser.add_argument('--alpha_cat_loss', type=float, default=0, help='alpha for cat')
parser.add_argument('--alpha_align_loss', type=float, default=0., help='alpha for align')
